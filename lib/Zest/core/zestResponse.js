 ...
 */
function ZestResponse (response, withRespBody) {
  ...
  this.responseTimeInMs = response.responseTimeInMs;
}
...
ZestResponse.prototype = {
  ...
  toZest: function() {
    let zst = {
      ...
      'body': this.withRespBody ? this.getBody() : '',
      'statusCode': this.getStatusCode(),
      'responseTimeInMs': this.getResponseTimeInMs(),
